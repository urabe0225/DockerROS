...
{
private:
    op::Wrapper* _opWrapper;
    ros::NodeHandle* _n;
public:
    PoseRos(ros::NodeHandle* n, op::Wrapper* opWrapper):
    _n(n), _opWrapper(opWrapper){
...
int main(int argc, char **argv)
{
  ...
  */
    ...
    {   
        ...
        PoseRos rop(&n, &opWrapper);
        op::opLog(FLAGS_prototxt_path, op::Priority::High);
